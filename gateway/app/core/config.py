...
from app.core.qa_modes import parse_enabled_qa_modes
...
class GatewaySettings:
    ...
    enabled_qa_modes: frozenset[str] = field(default_factory=lambda: frozenset({"fast", "thinking", "patent"}))
    ...
    def from_env(cls) -> "GatewaySettings":
        ...
        return cls(
            ...
            enabled_qa_modes=parse_enabled_qa_modes(),
        )
