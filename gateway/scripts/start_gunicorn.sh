...
export GATEWAY_ENV_FILES="${GATEWAY_ENV_FILES:-$MONOREPO_CONFIG_ENV_FILES:$PROJECT_ROOT/config.env:$PROJECT_ROOT/config.shared.env:$PROJECT_ROOT/config.secret.env:$PROJECT_ROOT/.env:$GATEWAY_SHARED_ENV_FILES:$CONFIG_DIR_DEFAULT/config.shared.env:$CONFIG_DIR_DEFAULT/config.secret.env:$CONFIG_DIR_DEFAULT/.env:$CONFIG_DIR_DEFAULT/config.env}"
