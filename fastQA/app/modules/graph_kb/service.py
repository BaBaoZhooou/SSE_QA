...
from app.modules.graph_kb.sse_retriever import route_sse_graph_kb
...
def route_graph_kb_v2(
    *,
    ...
    schema = str(os.getenv("FASTQA_GRAPH_KB_SCHEMA", "lifepo4") or "lifepo4").strip().lower()
    if schema == "sse":
        return route_sse_graph_kb(
            question=question,
            neo4j_client=neo4j_client,
            max_rows=max_rows,
