...
class PatentRetrievalService:
    ...
    def _preprocess_retrieval_query(self, query: str) -> str:
        ...
        synonyms = {
            "LLZO": "Li7La3Zr2O12 石榴石",
            "LGPS": "Li10GeP2S12 硫化物电解质",
            "Li6PS5Cl": "LPSCl argyrodite 银辉石",
            "SSE": "solid-state electrolyte 固态电解质",
            "固态电解质": "SSE solid-state electrolyte",
            "硫化物电解质": "sulfide electrolyte LGPS Li6PS5Cl",
            "氧化物电解质": "oxide electrolyte LLZO LAGP",
            "聚合物电解质": "polymer electrolyte PEO SPE",
            "PEO": "聚环氧乙烷 polymer electrolyte",
            "PVDF": "聚偏氟乙烯",
            "NMP": "N-甲基吡咯烷酮",
            "离子电导率": "ionic conductivity",
            "界面阻抗": "interface resistance",
