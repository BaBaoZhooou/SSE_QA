...
from server.patent.prompt_loader import load_patent_intent_tag_descriptions, load_patent_prompt_template
...
def _intent_tag_descriptions() -> dict[str, str]:
    return load_patent_intent_tag_descriptions()
...
def build_intent_detect_system_prompt() -> str:
    ...
    template = load_patent_prompt_template("intent_detect_system.txt")
