...
export PATENT_ENV_FILES="${PATENT_ENV_FILES:-$MONOREPO_CONFIG_ENV_FILES:$PATENT_SHARED_ENV_FILES:$CONFIG_DIR_DEFAULT/config.env:$CONFIG_DIR_DEFAULT/config.shared.env:$CONFIG_DIR_DEFAULT/config.secret.env:$ROOT_DIR/.env}"
